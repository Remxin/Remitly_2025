...
func RandomSwift() AddSwiftCodeRequest {
	return AddSwiftCodeRequest{
		Address:       utils.RandomString(10),
		BankName:      utils.RandomString(10),
		CountryISO2:   utils.RandomString(2),
		CountryName:   utils.RandomString(5),
		IsHeadquarter: true,
		SwiftCode:     utils.RandomSwift(),
	}
}
